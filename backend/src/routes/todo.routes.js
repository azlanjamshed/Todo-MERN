...
const { create, editTodo, deleteTodo, allTodo, updateTodoStatus, filterTodo, singleTodo } = require("../controllers/todo.controller")
...
router.get("/:id", ensureAuthentication, singleTodo);
